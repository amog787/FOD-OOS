...
.method restoreTasksForUserLocked(ILandroid/util/SparseBooleanArray;)Ljava/util/List;
    ...
    .line 275
    .local v3, "tasks":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/wm/TaskRecord;>;"
    new-instance v0, Landroid/util/ArraySet;
    ...
    invoke-static {v0, v9}, Lcom/android/server/wm/TaskRecord;->restoreFromXml(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/wm/ActivityStackSupervisor;)Lcom/android/server/wm/TaskRecord;
    ...
    :try_start_3
    iget v6, v9, Lcom/android/server/wm/TaskRecord;->taskId:I

    .line 333
    .local v6, "taskId":I
    iget-object v12, v1, Lcom/android/server/wm/TaskPersister;->mService:Lcom/android/server/wm/ActivityTaskManagerService;

    iget-object v12, v12, Lcom/android/server/wm/ActivityTaskManagerService;->mRootActivityContainer:Lcom/android/server/wm/RootActivityContainer;
    :try_end_3
    ...
    .local v17, "taskNdx":I
    :try_start_4
    invoke-virtual {v12, v6, v8}, Lcom/android/server/wm/RootActivityContainer;->anyTaskForId(II)Lcom/android/server/wm/TaskRecord;
    ...
    iget v12, v9, Lcom/android/server/wm/TaskRecord;->userId:I
    ...
    invoke-virtual {v8, v6, v2}, Lcom/android/server/wm/ActivityStackSupervisor;->setNextTaskIdForUserLocked(II)V

    .line 344
    const/4 v8, 0x1

    iput-boolean v8, v9, Lcom/android/server/wm/TaskRecord;->isPersistable:Z
    ...
    iget v7, v6, Lcom/android/server/wm/TaskRecord;->mPrevAffiliateTaskId:I

    invoke-direct {v1, v7, v3}, Lcom/android/server/wm/TaskPersister;->taskIdToTask(ILjava/util/ArrayList;)Lcom/android/server/wm/TaskRecord;
    ...
    .line 380
    iget v7, v6, Lcom/android/server/wm/TaskRecord;->mNextAffiliateTaskId:I

    invoke-direct {v1, v7, v3}, Lcom/android/server/wm/TaskPersister;->taskIdToTask(ILjava/util/ArrayList;)Lcom/android/server/wm/TaskRecord;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/android/server/wm/TaskRecord;->setNextAffiliate(Lcom/android/server/wm/TaskRecord;)V
